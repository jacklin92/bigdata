...
def generate_text(messages):
    ...
    Simplified to focus only on the generation process.
    """
    # messages = [
...
def api_get_llm_response(request):
    ...
    if conversation_history:
        # This doesn't concatenate dictionaries - it adds all items from conversation_history 
        # to the messages list. Each item in conversation_history is a separate dictionary.
